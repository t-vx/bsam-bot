<?php
date_default_timezone_set('Asia/Jeddah');
if(!file_exists('config.json')){
	$token = readline('-Hi HUNTER Enter Token: ');
	$id = readline('-Hi HUNTER Enter Id: ');
		       ...
		       'chat_id'=>$chatId,
                ...
                'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>'Start Checking ⏸','callback_data'=>'run'],['text'=>'Stop Checking ▶️','callback_data'=>'stop']],
                          [['text'=>'Accounts Status ♻️','callback_data'=>'status']],
                          [['text'=>'HUNTER 🧑🏻‍💻','url'=>'t.me/bbzzs'],['text'=>'𝐌𝐘 𝐁𝐎𝐓𝐒 🔊','url'=>'t.me/Corona_virus_numbers_bot']]
                      ]
                  ])
               ]);
           } if($text == 'start'){
		       ...
		       'chat_id'=>$chatId,
                ...
                'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>'♻️ حاله الحسابات','callback_data'=>'status']],
                          [['text'=>'مطور البوت 👨🏻‍💻','url'=>'t.me/bbzzs'],['text'=>'قناة البوت 🔊','url'=>'t.me/devhuhu']]
                      ]
                  ])
               ]);
...
طريقة عمل بوت الصيد هيه انك تقوم بجمع يوزرات من الانستقرام ووضعها بالبوت ويقوم بالتخمين على المتابعين او الذين يقوم بمتابعتهم حسب اختيار بالطبع هناك طرق اخرى للسحب عبر هاشتاق متلا او كلمات بالبحث",
          	...
          	if($config['mode'] != null){
                  ...
                  'reply_markup'=>json_encode([
					...
					$bot->sendvideo([
       'chat_id'=>$chatId,
       'video'=> "https://t.me/abdalrahmanmasyd/1498",
        'caption'=>'شتريد؟',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'▫️| مطور البوت','url'=>'t.me/Corona_virus_numbers_bot']],
                       [['text'=>"قرآن", 'url'=>"t.me/abdalrahmanmasyd/1491"]],
                  ]
							])
					]);
				}
