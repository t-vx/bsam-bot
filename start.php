                    ...
                    if(checkMail($mail)){
                        ...
                        if ($inInsta !== false) {
                            // if($config['filter'] <= $follow){
                                ...
                                $following = $info['ff'];
                                $media = $info['m'];
                                bot('sendMessage', ['disable_web_page_preview' => true, 'chat_id' => $id, 'text' => "وصلك حساب يقلبي \n━━━━━━━━━━━━\n𓄼.𝐔𝐒𝐄𝐑:  [$usern](instagram.com/$usern)\n𓄼.𝐄𝐌𝐀𝐈𝐋 : [$mail]\n𓄼.𝐅𝐨𝐥𝐥𝐨𝐰𝐞𝐫𝐬: $follow\n𓄼.𝐅𝐨𝐥𝐥𝐨𝐰𝐢𝐧𝐠: $following\n𓄼.𝐏𝐎𝐒𝐓: $media\n━━━━━━━━━━━━\n CH : @DEVHUHU BOT [BOT](t.me/Corona_virus_numbers_bot)",
                                'parse_mode'=>'markdown']);
